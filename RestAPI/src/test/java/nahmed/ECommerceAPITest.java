...
public class ECommerceAPITest {
	...
	public static void main(String[] args) {
		...
		loginRequest.setUserEmail("iamriyaz47@gmail.com");
		loginRequest.setUserPassword("Dec@2021");
		...
		.multiPart("productImage",new File("C:\\Users\\iamni\\Downloads\\hqdefault.jpg"));
		...
		String getProductResponse = getProdReq.when().get("/api/ecom/order/get-orders-details")
		.then().log().all().extract().response().asString();
